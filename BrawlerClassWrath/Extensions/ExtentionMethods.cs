...
namespace BrawlerClassWrath.Extensions {
    static class ExtentionMethods {
        ...
        static readonly FastRef<BlueprintArchetype, Sprite> blueprintArchetype_set_Icon = Helpers.CreateFastRef<BlueprintArchetype, Sprite>("m_Icon");

        public static void FixDomainSpell(this BlueprintAbility spell, int level, string spellListId) {
            var spellList = BrawlerClassWrath.Resources.GetBlueprint<BlueprintSpellList>(spellListId);
